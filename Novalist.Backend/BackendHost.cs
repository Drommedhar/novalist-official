...
public sealed class BackendHost : IDisposable
{
    ...
    public JsonRpc Attach(Stream sending, Stream receiving)
    {
        ...
        rpc.AddLocalRpcTarget(new WikiPagesRpc(_workspace), targetOptions);
        rpc.AddLocalRpcTarget(new SubmissionsRpc(_workspace), targetOptions);
        rpc.AddLocalRpcTarget(new TasksRpc(_workspace), targetOptions);
        ...
        rpc.AddLocalRpcTarget(new NamesRpc(), targetOptions);
        ...
        rpc.AddLocalRpcTarget(new CraftRpc(), targetOptions);
