...
- **The read-aloud voice list explains itself.** If nothing available speaks your writing language, Novalist now says so under the picker instead of letting "Match the writing language" quietly read your German in an English voice. It also explains the trap that catches everyone: voices added under Windows' **Narrator → Add natural voices** are reserved for Narrator and appear in no application at all, while the voices that do work arrive with a **language** added under Time & language. Losing an evening to that is easy and now avoidable.
