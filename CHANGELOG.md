...
- **The read-aloud voice list explains itself.** It shows what your system's speech engine offers, which on Windows can be fewer voices than you have installed — the older "Desktop" voices are not offered to applications. If nothing available speaks your writing language, Novalist now says so under the picker instead of letting "Match the writing language" quietly read your German in an English voice.
