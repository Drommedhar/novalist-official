...
- **Word targets on the Dashboard.** A card listing every act, chapter and scene target with its progress, where you can also set one - targets could previously only be reached by right-clicking in the binder, which meant most writers never found them.
