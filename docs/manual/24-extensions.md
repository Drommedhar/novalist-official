...
An extension can read **what your book is about** — the premise and paragraph you wrote in the [Premise](11-dashboard.md#premise) card on the Dashboard, the genre, audience, comparable titles, setting, blurb and one-page synopsis, and the [publishing metadata](20-export.md) down to the series name and position. This is what lets an assistant give you an answer written for a cosy mystery rather than for "a novel"; before, it could read every word of your draft and still had nothing to tell it what kind of book the words were meant to add up to. Reading only: an extension cannot rewrite what your book is meant to be.
