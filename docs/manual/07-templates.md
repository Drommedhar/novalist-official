...
Open **Settings** from **Go → Settings** in the menu bar, or by name from the command palette. With a project loaded, the **TEMPLATES** section lists one group per entity type — **Character Templates**, **Location Templates**, **Item Templates**, **Lore Templates**, and one group per custom type.
