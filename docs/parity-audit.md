...
- Entity creation wizard (interview flow) and template editor (creation
  from existing templates shipped; custom entity types with full CRUD,
  tabs, and the type manager dialog shipped).
