...
public class GrammarCheckServiceTests
{
    ...
    [InlineData("fr", "en-GB", "en-GB")]
    [InlineData("de-low", "en-GB,en-GB-oxendict", "en-GB")]
    [InlineData("de-low", "de-low,en-GB,en-GB-oxendict", "en-GB")]
    [InlineData("de-guillemet", "DE-GUILLEMET,en-GB", "en-GB")]
    [InlineData("de-low", "de-low", "de-DE")]
    [InlineData("de-guillemet", " en-gb , EN-gb-oxendict ", "en-GB")]
    [InlineData("de-low", "en-US,en-GB", "en-US")]
    [InlineData("de-low", "en", "en-US")]
    [InlineData("en", "fr-FR,fr", "fr")]
    [InlineData("de-low", " , ", "de-DE")]
    [InlineData("de-low", "", "de-DE")]
    [InlineData("de-low", "en-GB,fr", "de-DE")]
    [InlineData("cs", "cs", "cs")]
    [InlineData("sk", "sk", "sk")]
    [InlineData("zh-CN", "zh-CN", "zh-CN")]
    [InlineData("ko", "ko", "ko")]
    [InlineData("en", "cs", "cs")]
    [InlineData("en", "el-GR", "el")]
    [InlineData("en", "af", "af")]
    public void ResolveLanguageCode_UsesDictionaryLanguageWhenUnambiguousOtherwiseWritingLanguage(
